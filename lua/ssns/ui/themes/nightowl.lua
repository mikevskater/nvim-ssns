...
return {
  ...
  colors = {
    ...
    schema = { fg = "#C792EA" },
    table = { fg = "#7FDBCA" },
    temp_table = { fg = "#F78C6C", italic = true },       -- Orange italic (#temp, ##global)
    view = { fg = "#FFCB8B" },
    procedure = { fg = "#F78C6C" },
    ["function"] = { fg = "#82AAFF" },
    column = { fg = "#D6DEEB" },
    ...
    keyword_global_variable = { fg = "#FF5874" },         -- Red (@@ROWCOUNT, @@VERSION, etc.)
    keyword_system_procedure = { fg = "#FFCB8B" },        -- Yellow (sp_*, xp_*)
    ...
    ui_border = { fg = "#82AAFF" },                       -- Blue border
    ui_title = { fg = "#C792EA", bold = true },           -- Purple bold title
    ui_selected = { fg = "#D6DEEB", bg = "#1D3B53" },    -- Foreground on selection
    ui_hint = { fg = "#637777" },                         -- Gray hints
  },
}

...
return {
  ...
  colors = {
    ...
    schema = { fg = "#C678DD" },
    table = { fg = "#98C379" },
    temp_table = { fg = "#D19A66", italic = true },       -- Orange italic (#temp, ##global)
    view = { fg = "#E5C07B" },
    procedure = { fg = "#D19A66" },
    ["function"] = { fg = "#61AFEF" },
    column = { fg = "#ABB2BF" },
    ...
    keyword_global_variable = { fg = "#E06C75" },         -- Red (@@ROWCOUNT, @@VERSION, etc.)
    keyword_system_procedure = { fg = "#E5C07B" },        -- Yellow (sp_*, xp_*)
    ...
    ui_border = { fg = "#61AFEF" },                       -- Blue border
    ui_title = { fg = "#C678DD", bold = true },           -- Purple bold title
    ui_selected = { fg = "#ABB2BF", bg = "#2C323C" },    -- Foreground on selection
    ui_hint = { fg = "#5C6370" },                         -- Gray hints
  },
}

...
function Ssns.setup(user_config)
  ...
  -- Setup UI highlights
  local Highlights = require('nvim-ssns.ui.core.highlights')
  Highlights.setup()
...
function Ssns.refresh_all()
  require('nvim-ssns.api.connections').refresh_all()
end

---Connect to a saved connection
---@param connection_name string
function Ssns.connect(connection_name)
  require('nvim-ssns.api.connections').connect(connection_name)
end
...
function Ssns.get_connection(bufnr)
  return require('nvim-ssns.api.connections').get_connection(bufnr)
end

---Change database for current server connection
function Ssns.change_database()
  require('nvim-ssns.api.connections').change_database()
end
...
function Ssns.get_cache()
  return require('nvim-ssns.cache')
end

---Get factory instance
---@return Factory
function Ssns.get_factory()
  return require('nvim-ssns.factory')
end

---Get config instance
---@return Config
function Ssns.get_config()
  return require('nvim-ssns.config')
end

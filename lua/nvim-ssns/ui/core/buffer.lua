...
function UiBuffer.setup_keymaps()
  ...
  local keymaps = {
    -- Close window
    {
      ...
      rhs = "<Cmd>lua require('nvim-ssns.ui.core.buffer').close()<CR>",
      desc = "Close SSNS",
    },
    -- Expand/collapse node
    {
      lhs = km.toggle or "<CR>",
      rhs = "<Cmd>lua require('nvim-ssns.ui.core.tree').toggle_node()<CR>",
    ...
    {
      lhs = km.refresh or "r",
      rhs = "<Cmd>lua require('nvim-ssns.ui.core.tree').refresh_node()<CR>",
      desc = "Refresh node",
    },
    {
      lhs = km.refresh_all or "R",
      rhs = "<Cmd>lua require('nvim-ssns.ui.core.tree').refresh_all()<CR>",
      desc = "Refresh all",
    },
    -- Filter
    {
      lhs = km.filter or "f",
      rhs = "<Cmd>lua require('nvim-ssns.ui.core.tree').open_filter()<CR>",
      desc = "Filter group",
    },
    {
      lhs = km.filter_clear or "F",
      rhs = "<Cmd>lua require('nvim-ssns.ui.core.tree').clear_filter()<CR>",
      desc = "Clear filter",
    },
    -- Connect/disconnect
    {
      lhs = km.toggle_connection or "d",
      rhs = "<Cmd>lua require('nvim-ssns.ui.core.tree').toggle_connection()<CR>",
    ...
    {
      lhs = km.help or "?",
      rhs = "<Cmd>lua require('nvim-ssns.ui.core.buffer').show_help()<CR>",
      desc = "Show help",
    },
    -- New query buffer
    {
      lhs = km.new_query or "<C-n>",
      rhs = "<Cmd>lua require('nvim-ssns.ui.core.tree').new_query_from_context()<CR>",
    ...
    -- Toggle parent group
    {
      ...
      rhs = "<Cmd>lua require('nvim-ssns.ui.core.tree').toggle_group()<CR>",
      desc = "Toggle parent group",
    },
    -- Add server
    {
      lhs = km.add_server or "a",
      rhs = "<Cmd>lua require('nvim-ssns.ui.dialogs.add_server').open()<CR>",
      desc = "Add server connection",
    },
    -- Toggle favorite
    {
      lhs = km.toggle_favorite or "*",
      rhs = "<Cmd>lua require('nvim-ssns.ui.core.tree').toggle_favorite()<CR>",
      desc = "Toggle server favorite",
    },
    -- Show history
    {
      lhs = km.show_history or "<Leader>@",
      rhs = "<Cmd>lua require('nvim-ssns.ui.core.tree').show_history_from_context()<CR>",
      desc = "Show query history for server",
    },
    -- View definition (ALTER script)
    {
      lhs = km.view_definition or "K",
      rhs = "<Cmd>lua require('nvim-ssns.ui.core.tree').view_definition()<CR>",
      desc = "View object definition",
    },
    -- View metadata
    {
      lhs = km.view_metadata or "M",
      rhs = "<Cmd>lua require('nvim-ssns.ui.core.tree').view_metadata()<CR>",
      desc = "View object metadata",
    },
    -- Cancel loading operation
    {
      lhs = km.cancel or "<C-c>",
      rhs = "<Cmd>lua require('nvim-ssns.ui.core.tree').cancel_loading()<CR>",
      desc = "Cancel loading operation",
    },
    -- Mouse support
    {
      lhs = "<LeftMouse>",
      rhs = "<Cmd>lua require('nvim-ssns.ui.core.tree').handle_mouse_click()<CR>",
    ...
    local nav_keymaps = {
      {
        ...
        rhs = function()
          ...
          require('nvim-ssns.ui.core.buffer').move_cursor_down(count)
        end,
      ...
      },
      {
        ...
        rhs = function()
          local count = vim.v.count1
          require('nvim-ssns.ui.core.buffer').move_cursor_up(count)
        end,
